...
class CallGraph : public RecursiveASTVisitor<CallGraph> {
  ...
  llvm::DenseMap<const Expr *, std::unique_ptr<CallGraphNode>> ExprMap;
...
public:
  ...
  CallGraphNode *getOrInsertExprNode(Expr *);
  ...
  void viewGraph(std::string) const;
...
public:
  CallGraphNode(Decl *D) : FD(D){Ex = NULL;}

  CallGraphNode(Expr *E): Ex(E){FD = NULL;}
